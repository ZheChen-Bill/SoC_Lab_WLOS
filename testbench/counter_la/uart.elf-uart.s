...
.L39:
	...
	lw	a5,-28(s0)
	slli	a4,a5,2
	.loc 2 97 35 discriminator 3
	lw	a5,-24(s0)
	add	a5,a4,a5
	.loc 2 97 28 discriminator 3
	lui	a4,%hi(B)
	addi	a4,a4,%lo(B)
	slli	a5,a5,2
	add	a5,a4,a5
	lw	a5,0(a5)
	.loc 2 97 25 discriminator 3
	mv	a1,a5
	mv	a0,a3
	call	__mulsi3
	mv	a5,a0
	mv	a4,a5
	.loc 2 97 9 discriminator 3
	lw	a5,-32(s0)
	add	a5,a5,a4
	sw	a5,-32(s0)
	...
	sw	a5,-28(s0)
.L38:
	.loc 2 96 15 discriminator 1
	lw	a4,-28(s0)
	li	a5,3
	ble	a4,a5,.L39
	.loc 2 98 13 discriminator 2
	lw	a5,-20(s0)
	slli	a4,a5,2
	.loc 2 98 17 discriminator 2
	lw	a5,-24(s0)
	add	a5,a4,a5
	.loc 2 98 22 discriminator 2
	lui	a4,%hi(result)
...
.L46:
	...
	sw	a4,0(a5)
.L45:
	.loc 2 109 20 discriminator 2
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L44:
	.loc 2 109 15 discriminator 1
	lw	a4,-24(s0)
	lw	a5,-40(s0)
	blt	a4,a5,.L46
	.loc 2 117 6
