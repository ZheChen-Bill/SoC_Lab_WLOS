...
HD_PWD='/home/ubuntu/SoC_Design/caravel-soc_fpga-lab/lab-wlos_baseline/vivado/vvd_caravel_fpga/vvd_caravel_fpga.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
